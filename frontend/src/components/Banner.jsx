...
<div className="max-w-screen-2xl container mx-auto md-px-20 px-4 flex flex-col md:flex-row my-10">
   ...
   <p  className="text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem debitis, autem eveniet architecto illum officiis iusto totam eos qui recusandae sint dolor voluptate quasi corrupti mollitia, libero dolores optio dignissimos.</p>
